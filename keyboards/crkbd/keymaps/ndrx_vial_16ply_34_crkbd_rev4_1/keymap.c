...
// ##################################################################################### LINUX ###################################################################
  ...
  [0] = LAYOUT_split_3x6_3_ex2(   // DF(0): _QWERTY
  //,------------------------------------------------------------------------------------------.  ,--------------------------------------------------------------.
  ...
  [1] = LAYOUT_split_3x6_3_ex2(   // DF(1): _COLEMAK_DH
  //,------------------------------------------------------------------------------------------.  ,--------------------------------------------------------------.
  ...
  [2] = LAYOUT_split_3x6_3_ex2(   // _EXT: EXTend / NAVigation layer
  //,------------------------------------------------------------------------------------------.  ,--------------------------------------------------------------.
      KC_NO,        KC_ESC,    LCTL(KC_F), LALT(KC_LEFT), LALT(KC_RGHT),        KC_INS,   KC_NO,      KC_NO,   KC_HOME, KC_PGDN, KC_PGUP,  KC_END, KC_CAPS, KC_NO,
  //|------+--------------+--------------+--------------+--------------+--------------+--------|  |--------+----------+--------+--------+--------+--------+------|
      KC_NO, OSM(MOD_LALT), OSM(MOD_LGUI), OSM(MOD_LSFT), OSM(MOD_LCTL), OSM(MOD_RALT),   KC_NO,      KC_NO,   KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT,  KC_DEL, KC_NO,
  //|------+--------------+--------------+--------------+--------------+--------------+--------'  `--------+----------+--------+--------+--------+--------+------|
  ...
  [3] = LAYOUT_split_3x6_3_ex2(   // _SYM: Symbol layer
  //,------------------------------------------------------------------------------------------.  ,--------------------------------------------------------------.
      KC_NO,       KC_EXLM,         KC_AT,       KC_HASH,        KC_DLR,       KC_PERC,   KC_NO,    KC_NO,      KC_EQL,  KC_GRV, KC_QUOT, KC_DQUO, KC_PLUS, KC_NO,
  //|------+--------------+--------------+--------------+--------------+--------------+--------|  |--------+----------+--------+--------+--------+--------+------|
      KC_NO, OSM(MOD_LALT), OSM(MOD_LGUI), OSM(MOD_LSFT), OSM(MOD_LCTL),       KC_CIRC,   KC_NO,    KC_NO,     KC_ASTR, KC_LPRN, KC_LCBR, KC_LBRC, KC_MINS, KC_NO,
  //|------+--------------+--------------+--------------+--------------+--------------+--------'  `--------+----------+--------+--------+--------+--------+------|
  ...
  [4] = LAYOUT_split_3x6_3_ex2(   // _NUM: Number layer
  //,------------------------------------------------------------------------------------------.  ,--------------------------------------------------------------.
      KC_NO,         KC_NO,         KC_NO,       KC_COMM,        KC_DOT,        KC_NO,    KC_NO,      KC_NO,    KC_EQL,    KC_7,    KC_8,    KC_9, KC_PLUS, KC_NO,
  //|------+--------------+--------------+--------------+--------------+--------------+--------|  |--------+----------+--------+--------+--------+--------+------|
      KC_NO, OSM(MOD_LALT), OSM(MOD_LGUI), OSM(MOD_LSFT), OSM(MOD_LCTL), OSM(MOD_RALT),   KC_NO,      KC_NO,   KC_ASTR,    KC_4,    KC_5,    KC_6, KC_MINS, KC_NO,
  //|------+--------------+--------------+--------------+--------------+--------------+--------'  `--------+----------+--------+--------+--------+--------+------|
  ...
  [5] = LAYOUT_split_3x6_3_ex2(   // _FUN: Function layer
  //,------------------------------------------------------------------------------------------.  ,--------------------------------------------------------------.
      KC_NO,         KC_NO,       KC_MUTE,       KC_VOLD,       KC_VOLU,         KC_NO,   KC_NO,      KC_NO,    KC_F12,   KC_F7,   KC_F8,   KC_F9,   KC_NO, KC_NO,
  //|------+--------------+--------------+--------------+--------------+--------------+--------|  |--------+----------+--------+--------+--------+--------+------|
      KC_NO, OSM(MOD_LALT), OSM(MOD_LGUI), OSM(MOD_LSFT), OSM(MOD_LCTL), OSM(MOD_RALT),   KC_NO,      KC_NO,    KC_F11,   KC_F4,   KC_F5,   KC_F6,   KC_NO, KC_NO,
  //|------+--------------+--------------+--------------+--------------+--------------+--------'  `--------+----------+--------+--------+--------+--------+------|
  ...
  [6] = LAYOUT_split_3x6_3_ex2(   // _SYS: System layer
  //,------------------------------------------------------------------------------------------.  ,--------------------------------------------------------------.
      KC_NO,       RGB_TOG,         KC_NO,       QK_BOOT,        EE_CLR,     QK_REBOOT,   KC_NO,      KC_NO, QK_REBOOT,  EE_CLR, QK_BOOT,   KC_NO,   KC_NO, KC_NO,
  //|------+--------------+--------------+--------------+--------------+--------------+--------|  |--------+----------+--------+--------+--------+--------+------|
      KC_NO,       RGB_MOD,       RGB_VAI,       RGB_HUI,       RGB_SAI,       RGB_SPI,   KC_NO,      KC_NO,     KC_NO,   KC_NO,   KC_NO,   DF(0),   DF(8), KC_NO,
  //|------+--------------+--------------+--------------+--------------+--------------+--------'  `--------+----------+--------+--------+--------+--------+------|
  ...
  [7] = LAYOUT_split_3x6_3_ex2(   // _EXTRA: Extra layer, currently unused
  //,------------------------------------------------------------------------------------------.  ,--------------------------------------------------------------.
...
// ##################################################################################### MACOS ###################################################################
  ...
  [8] = LAYOUT_split_3x6_3_ex2(   // DF(8): _QWERTY_MAC
  //,------------------------------------------------------------------------------------------.  ,--------------------------------------------------------------.
      KC_NO,          KC_Q,          KC_W,          KC_E,          KC_R,          KC_T,   KC_NO,      KC_NO,      KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_NO,
  //|------+--------------+--------------+--------------+--------------+--------------+--------|  |--------+----------+--------+--------+--------+--------+------|
      KC_NO,          KC_A,          KC_S,          KC_D,          KC_F,          KC_G,   KC_NO,      KC_NO,      KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_NO,
  ...
  [9] = LAYOUT_split_3x6_3_ex2(   // DF(9): _COLEMAK_DH_MAC
  //,------------------------------------------------------------------------------------------.  ,--------------------------------------------------------------.
      KC_NO,          KC_Q,          KC_W,          KC_F,          KC_P,          KC_B,   KC_NO,      KC_NO,      KC_J,    KC_L,    KC_U,    KC_Y, KC_SCLN, KC_NO,
  //|------+--------------+--------------+--------------+--------------+--------------+--------|  |--------+----------+--------+--------+--------+--------+------|
      KC_NO,          KC_A,          KC_R,          KC_S,          KC_T,          KC_G,   KC_NO,      KC_NO,      KC_M,    KC_N,    KC_E,    KC_I,    KC_O, KC_NO,
  ...
  [10] = LAYOUT_split_3x6_3_ex2(   // _EXT_MAC: EXTend / NAVigation layer
  //,------------------------------------------------------------------------------------------.  ,--------------------------------------------------------------.
      KC_NO,        KC_ESC,    LGUI(KC_F), LALT(KC_LEFT), LALT(KC_RGHT),        KC_INS,   KC_NO,      KC_NO,   KC_HOME, KC_PGDN, KC_PGUP,  KC_END, KC_CAPS, KC_NO,
  //|------+--------------+--------------+--------------+--------------+--------------+--------|  |--------+----------+--------+--------+--------+--------+------|
      KC_NO, OSM(MOD_LALT), OSM(MOD_LGUI), OSM(MOD_LSFT), OSM(MOD_LCTL), OSM(MOD_RALT),   KC_NO,      KC_NO,   KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT,  KC_DEL, KC_NO,
  //|------+--------------+--------------+--------------+--------------+--------------+--------'  `--------+----------+--------+--------+--------+--------+------|
  ...
  [11] = LAYOUT_split_3x6_3_ex2(   // _SYM_MAC: Symbol layer
  //,------------------------------------------------------------------------------------------.  ,--------------------------------------------------------------.
      KC_NO,       KC_EXLM,         KC_AT,       KC_HASH,        KC_DLR,       KC_PERC,   KC_NO,    KC_NO,      KC_EQL,  KC_GRV, KC_QUOT, KC_DQUO, KC_PLUS, KC_NO,
  //|------+--------------+--------------+--------------+--------------+--------------+--------|  |--------+----------+--------+--------+--------+--------+------|
      KC_NO, OSM(MOD_LALT), OSM(MOD_LGUI), OSM(MOD_LSFT), OSM(MOD_LCTL),       KC_CIRC,   KC_NO,    KC_NO,     KC_ASTR, KC_LPRN, KC_LCBR, KC_LBRC, KC_MINS, KC_NO,
  ...
  [12] = LAYOUT_split_3x6_3_ex2(   // _NUM_MAC: Number layer
  //,------------------------------------------------------------------------------------------.  ,--------------------------------------------------------------.
      KC_NO,         KC_NO,         KC_NO,       KC_COMM,        KC_DOT,        KC_NO,    KC_NO,      KC_NO,    KC_EQL,    KC_7,    KC_8,    KC_9, KC_PLUS, KC_NO,
  //|------+--------------+--------------+--------------+--------------+--------------+--------|  |--------+----------+--------+--------+--------+--------+------|
      KC_NO, OSM(MOD_LALT), OSM(MOD_LGUI), OSM(MOD_LSFT), OSM(MOD_LCTL), OSM(MOD_RALT),   KC_NO,      KC_NO,   KC_ASTR,    KC_4,    KC_5,    KC_6, KC_MINS, KC_NO,
  ...
  [13] = LAYOUT_split_3x6_3_ex2(   // _FUN_MAC: Function layer
  //,------------------------------------------------------------------------------------------.  ,--------------------------------------------------------------.
      KC_NO,         KC_NO,       KC_MUTE,       KC_VOLD,       KC_VOLU,         KC_NO,   KC_NO,      KC_NO,    KC_F12,   KC_F7,   KC_F8,   KC_F9,   KC_NO, KC_NO,
  //|------+--------------+--------------+--------------+--------------+--------------+--------|  |--------+----------+--------+--------+--------+--------+------|
      KC_NO, OSM(MOD_LALT), OSM(MOD_LGUI), OSM(MOD_LSFT), OSM(MOD_LCTL), OSM(MOD_RALT),   KC_NO,      KC_NO,    KC_F11,   KC_F4,   KC_F5,   KC_F6,   KC_NO, KC_NO,
  ...
  [14] = LAYOUT_split_3x6_3_ex2(   // _SYS_MAC: System layer
  //,------------------------------------------------------------------------------------------.  ,--------------------------------------------------------------.
      KC_NO,       RGB_TOG,         KC_NO,       QK_BOOT,        EE_CLR,     QK_REBOOT,   KC_NO,      KC_NO, QK_REBOOT,  EE_CLR, QK_BOOT,   KC_NO,   KC_NO, KC_NO,
  //|------+--------------+--------------+--------------+--------------+--------------+--------|  |--------+----------+--------+--------+--------+--------+------|
      KC_NO,       RGB_MOD,       RGB_VAI,       RGB_HUI,       RGB_SAI,       RGB_SPI,   KC_NO,      KC_NO,     KC_NO,   KC_NO,   KC_NO,   DF(0),   DF(8), KC_NO,
  ...
  [15] = LAYOUT_split_3x6_3_ex2(   // _EXTRA_MAC: Extra layer, currently unused
  //,------------------------------------------------------------------------------------------.  ,--------------------------------------------------------------.
      KC_NO,         KC_NO,         KC_NO,         KC_NO,         KC_NO,         KC_NO,   KC_NO,      KC_NO,     KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_NO,
  //|------+--------------+--------------+--------------+--------------+--------------+--------|  |--------+----------+--------+--------+--------+--------+------|
      KC_NO,         KC_NO,         KC_NO,         KC_NO,         KC_NO,         KC_NO,   KC_NO,      KC_NO,     KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_NO,
